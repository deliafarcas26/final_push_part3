...
function App() {
  ...
  const [currentView, setCurrentView] = useState<
    "feed" | "profile" | "settings" | "about" | "users" | "userProfile"
  >("feed");
  ...
  const handleMenuItemClick = (
    view: "feed" | "profile" | "settings" | "about" | "users"
  ) => {
    setCurrentView(view);
    setDrawerOpen(false);
          ...
          <div className="container mx-auto px-4 py-8">
            ...
            <div className="bg-white rounded-lg shadow p-6">
              ...
              <p className="text-gray-600 mb-4">
                A secure, internal business communication platform combining
                work, achievement, and connection.
              </p>
