  ...
  return (
    <div className="container mx-auto px-4 py-8 max-w-4xl">
      <div className="bg-white rounded-xl shadow-2xl overflow-hidden">
        {/* Header */}
        <div className="p-6 bg-gradient-to-r from-blue-500 to-primary-600 text-white">
          <h1 className="text-3xl font-extrabold">Prieteni</h1>
          <p className="text-blue-200 mt-2">
            Vizualizează și accesează profilurile colegilor tăi
          </p>
        </div>
            ...
            <div className="text-center py-12">
              <p className="text-gray-500 text-lg">
                {searchTerm
                  ...
                  : "Nu există alți utilizatori pe platformă."}
              </p>
            </div>
          ) : (
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              {filteredUsers.map((user) => (
                <div
                  ...
                  className="bg-gray-50 p-4 rounded-lg border border-gray-200 hover:border-primary-400 hover:shadow-lg transition-all cursor-pointer"
                >
                  <div className="flex items-center space-x-4">
                    {/* Avatar */}
                    <div className="flex-shrink-0">
                      <div className="w-14 h-14 bg-primary-200 rounded-full flex items-center justify-center text-primary-700 font-bold text-lg">
